...
public class LITPlinuxfirewallTestRunner extends TorTestCaseHelper {
    
    Logger logger = Logger.getLogger(LITPlinuxfirewallTestRunner.class);
    ...
    @TestId(id = "CXP9031173-1", title = "Upgrade ERIClitplinuxfirewall rpm on the MS")
    @Test(groups={"ACCEPTANCE"})
    public void upgradeERIClitplinuxfirewallRPM() throws TimeoutException, FileNotFoundException {

        rpmUpgradeOperator.initialise("linuxfirewall");
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "CXP9031173-2", title = "Run python test cases for ERIClitplinuxfirewall package")
    @Test(groups={"CDB_REGRESSION", "ACCEPTANCE"})
    public void runERIClitplinuxfirewallTests() {
     ...
     * @PRE Execution of test {@link #runERIClitplinuxfirewallTests()}
     * @PRIORITY HIGH
     * @param className
     * @param name
     * @param failures
     */
    @TestId(id = "CXP9031173-3", title = "Parse xml outputs from python tests")
